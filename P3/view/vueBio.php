...
<body>
    ...
    <section id="bio_auteur">
        <div class="container container_accueil">
            ...
            <div class="photo_auteur">
                <img class="col-xs-12 col-sm-12 col-md-offset-2 col-md-8 col-lg-offset-3 col-lg-6" src="public/img/forteroche.jpg" alt="Portrait Jean Forteroche">
            </div>
            ...
            <div class="bio_contenu">
                ...
                <br>
                En 2018, il décide de se rapprocher de ses lecteurs et de publier en ligne chapitre par chapitre sur son propre site, son dernier roman <em>BILLET SIMPLE POUR L'ALASKA</em>.<br>
                L'occasion pour lui de pourvoir interagir directement avec ses fans.</p>
            </div>        
        </div>
    </section>
    ...
    <section id="bibliographie_auteur">
        <div class="container container_accueil">
            <div class="title_bio">
                <h3>Bibliographie</h3>
            </div>
